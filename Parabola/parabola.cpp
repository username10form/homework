...
#endif
// CProgramDlg dialog
CProgramDlg::CProgramDlg(CWnd* pParent /*=nullptr*/)	: CDialog(IDD_PROGRAM_DIALOG, pParent)
{
m_hIcon = AfxGetApp()->LoadIcon(IDR_MAINFRAME);
}
void CProgramDlg::DoDataExchange(CDataExchange* pDX)
{	fg = true;	SetWindowTextW(L"Program");	CDialog::DoDataExchange(pDX);
}
...
DEFAULT_PITCH | FF_DONTCARE,	L"Trebuchet Ms");	
hold = (HFONT)SelectObject(dc, hNew);	
dc.FillSolidRect(&rc, RGB(255, 255, 255));		// горизонтальний та вертикальний розміри	
...
//  the minimized window.HCURSOR
CProgramDlg::OnQueryDragIcon()
{	
return static_cast<HCURSOR>(m_hIcon);
}
// квадратична функція
afx_msg double CProgramDlg::MyF1(double q)
{	
double res;	res = q*q + 4 * q + 3;
return res;
}
//тригонометрична функція
afx_msg double CProgramDlg::MyF2(double q)
{
double res;	res = sin(q);	return res;
}
